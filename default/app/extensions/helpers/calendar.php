...
<script type="text/javascript">
	...
	{				  
		...
		if(f!="")
		  ...
		  <select class="form-control-sin-wf" id="days'.$field_id.'" name="days'.$field_id.'"'.$attrs.'></select>/
		  <select class="form-control-sin-wf" id="mont'.$field_id.'" name="mont'.$field_id.'"'.$attrs.'></select>/
		  <select class="form-control-sin-wf" id="year'.$field_id.'" name="year'.$field_id.'"'.$attrs.'></select>	  
		  ';

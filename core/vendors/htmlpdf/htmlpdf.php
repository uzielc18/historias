...
OBS7: Regexp + Perl ([preg]accepts non-greedy quantifiers while PHP[preg_match_all] does not)
...
require_once CORE_PATH . 'vendors/htmlpdf/fpdf.php';
require_once CORE_PATH . 'vendors/htmlpdf/htmltoolkit.php';
...
function HTMLPDF($orientation='P',$unit='mm',$format='A4')
{
//! @desc Constructor
      ...
      //Start of 'if/elseif's
        ...
        $tag=strtoupper($a2[0]);
				...
				if (!empty($contents))
				{
  				...
  				{
  				    /* preg_match_all is deprecated remplace for preg_match*/
					if(preg_match('/(?:^|(?<=\&(?![a-z]+\;)))([^\=]+)=(.*?)(?:$|\&(?![a-z]+\;))/i',$v,$a3))
    					{
